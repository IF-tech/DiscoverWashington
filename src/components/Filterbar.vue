        ...
        <v-container fluid>
          <v-row align="center">
            ...
            <v-col>
              ...
              <v-col>
              <v-select
                v-model="selectedTrailTypes"
                :items="filters.trailTypes"
                label="Difficulty"
                multiple
                deletableChips="true"
                single-line
  ...
  data() {
    return {
      filters: {
        ...
        passTypes: ["No Pass Requirement", "Discover Pass", "NW Forest Pass", "Federal All Access Pass"],
        trailTypes: ["Easy Access", "Moderate/Difficult Access", "Technical Access Only", "Non-Motorized Only"],
      },
      e6: [],
      selectedCounties: [],
      selectedServices: [],
